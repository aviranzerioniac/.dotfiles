    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Pomodoro(length_long_break=20, length_short_break=5, length_pomodori=35, notification_on='True', num_pomodori=3, prefix_inactive='', prefix_pause='', update_interval=1),
