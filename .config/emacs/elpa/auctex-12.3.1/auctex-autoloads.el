...
(register-definition-prefixes "tex" '("Bib" "ConTeXt-" "LaTeX-" "TeX-" "VirTeX-common-initialization" "docTeX-default-extension" "ispell-tex-" "plain-TeX-auto-regexp-list" "tex-"))
...
(register-definition-prefixes "tex-buf" '("LaTeX-" "TeX-" "compilation-in-progress"))
